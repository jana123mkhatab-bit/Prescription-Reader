...
def generate_patient_summary(drug_profile: dict, diagnosis_text: str) -> dict:
    """
    ...
    Raises if both the primary and fallback models fail -- callers (see
    app.routes.prescription) catch this and show an "unavailable" state.
    """
